...
class Cars(pygame.sprite.Sprite):
    ...
    def build_coin(self, main_image):
        self.main_image = main_image
        pygame.draw.circle(self.main_image, "yellow", (self.rect_coin.center[0] + self.image_coin.get_rect().center[0],
                                                       self.rect_coin.center[1] + self.image_coin.get_rect().center[1]),
                           (6 - self.r_s) * 5)
...
pygame.mixer.music.load("snowdown.mp3")
